...
export default class FormComponent extends AbstractComponent {
  ...
  _getTemplate() {
    return (
      `<form aria-label="Форма додавання завдання" class="add-task__form">
        <div class="add-task__input-wrapper">
          <label for="add-task">${this._label}</label>
          <input id="add-task" name="task-name" placeholder="Назва завдання..." type="text" required minlength="${MIN_TITLE_LENGTH}">
        </div>
